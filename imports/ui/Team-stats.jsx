...
export default class TeamStats extends Component {
  render() {
    ...
    const ballManipulation = Math.round(
      (players.reduce((ballManipulation, player) => {
    ...
    const kickingAbilities = Math.round(
      (players.reduce((kickingAbilities, player) => {
    ...
    const passingAbilities = Math.round(
      (players.reduce((passingAbilities, player) => {
    ...
    const duelTackling = Math.round(
      (players.reduce((duelTackling, player) => {
    ...
    const fieldCoverage = Math.round(
      (players.reduce((fieldCoverage, player) => {
    ...
    const blockingAbilities = Math.round(
      (players.reduce((blockingAbilities, player) => {
    ...
    const gameStrategy = Math.round(
      (players.reduce((gameStrategy, player) => {
    ...
    const playmakingRisks = Math.round(
      (players.reduce((playmakingRisks, player) => {
